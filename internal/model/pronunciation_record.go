...
type PronunciationRecord struct {
	...
	AccuracyScore float32 `gorm:"type:decimal(3,1);not null;default:0" json:"accuracy_score"`
	Fluency       float32 `gorm:"type:decimal(3,1);not null;default:0" json:"fluency"`
	Integrity     float32 `gorm:"type:decimal(3,1);not null;default:0" json:"integrity"`
	StandardScore float32 `gorm:"type:decimal(3,1);not null;default:0" json:"standard_score"`
